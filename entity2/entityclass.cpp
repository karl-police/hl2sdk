...
int64 CEntityClass::UnserializeKey(
...
int64 CEntityClass::Unserialize(CEntityInstance* pEntity, const CEntityKeyValues* pKeyValues) {
    ...
    int64 entity_index; // v8, e.g. ent_attachments entity_index
